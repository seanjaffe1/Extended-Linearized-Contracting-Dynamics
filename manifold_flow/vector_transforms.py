...
def _create_vector_linear_transform(linear_transform_type, features):
    ...
    elif linear_transform_type == "naive_linear":
        return transforms.CompositeTransform([transforms.RandomPermutation(features=features), transforms.NaiveLinear(features)])
    else:
        raise ValueError
